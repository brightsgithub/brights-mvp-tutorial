...
public class CharactersEntity {
    ...
    @Generated(hash = 232996731)
    private transient CharactersEntityDao myDao;
    @Generated(hash = 1204788837)
    private transient Long resultComicEntity__resolvedKey;

    @Generated(hash = 462679008)
    public CharactersEntity(Long id, long resultComicEntityId, int available,
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 2048722129)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getCharactersEntityDao() : null;
    }
